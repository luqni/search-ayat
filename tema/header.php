...
<header class="header-transparent" id="header-main">
        <!-- Topbar -->
        <div id="navbar-top-main" class="navbar-top  navbar-dark border-bottom" style="background:linear-gradient(135deg,#138008 0,#11ad02 60%);!important">
            <div class="container">
                <div class="navbar-nav align-items-center">
                    <div class=" d-lg-inline-block">
                        <span class="navbar-text mr-3">Al - Qur'an Lafadz finder</span>
                    </div>
                    <div class="ml-auto">
                        <ul class="nav">
                            <li class="nav-item">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-main-collapse">
            <ul class="navbar-nav align-items-lg-center">
                ...
                <!-- <li class="nav-item active">
                    <a class="nav-link" target="_BLANK" href="https://instagram.com/werls.id" ><i class="fab fa-instagram"></i> Follow Instagram werls.id</a>
                </li> -->
            </ul>
        </div>
    </div>
